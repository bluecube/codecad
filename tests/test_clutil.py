...
def test_assert_pass():
    ...
    ev = codecad.cl_util.opencl_manager.k.assert_tester(
        (10, 10), None, numpy.uint32(100), assertBuffer
    )
...
def test_assert_fail():
    assertBuffer = codecad.cl_util.AssertBuffer()
    ev = codecad.cl_util.opencl_manager.k.assert_tester(
        (10, 10), None, numpy.uint32(5), assertBuffer
    )
...
def test_assert_fail_multiple():
    assertBuffer = codecad.cl_util.AssertBuffer()
    ev = codecad.cl_util.opencl_manager.k.assert_tester(
        (10, 10, 1000), None, numpy.uint32(5), assertBuffer
    )
...
def test_assert_chaining_pass():
    assertBuffer = codecad.cl_util.AssertBuffer()
    ev = codecad.cl_util.opencl_manager.k.assert_tester(
        (10, 10), None, numpy.uint32(101), assertBuffer
    )
    ev = codecad.cl_util.opencl_manager.k.assert_tester(
        (10, 10), None, numpy.uint32(102), assertBuffer, wait_for=[ev]
    )
...
def test_assert_chaining_multiple_fail():
    assertBuffer = codecad.cl_util.AssertBuffer()
    ev = codecad.cl_util.opencl_manager.k.assert_tester(
        (10, 10), None, numpy.uint32(1), assertBuffer
    )
    ev = codecad.cl_util.opencl_manager.k.assert_tester(
        (10, 10), None, numpy.uint32(2), assertBuffer, wait_for=[ev]
    )
